  ...
  return (
    <Link href={`/movie/${id}-${title}`} className="flex-none rounded-md">
      <div className="h-96 relative">
        ...
        <div className={`absolute top-0 right-0 p-2 rounded-tr-md font-semibold ${Number(average.toFixed(1)) * 10  < 50 ?  'bg-red-500': Number(average.toFixed(1)) * 10  < 65 ?'bg-yellow-500' : 'bg-green-500' }`}>
